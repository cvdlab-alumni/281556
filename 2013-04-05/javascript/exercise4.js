...
var floorspillar = STRUCT([pillarstot,floor0,floor1,floor2,floor3,floor4]);
...
var pareti = STRUCT([east,north,south,west]);

var all = STRUCT([pareti,floorspillar]);
