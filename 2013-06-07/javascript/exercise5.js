...
//lago
	...
	var allAlberigruppo4 = T([0,1,2])(mapping([4,7.8]))(allalberib);
	...
	var alberiAll = STRUCT([allAlberigruppo1,allAlberigruppo2,allAlberigruppo3,allAlberigruppo4,Albero1,Albero2,Albero3]);
	...
	//CASE
			...
			var stradevert = COLOR([0.25,0.25,0.25])(SIMPLEX_GRID([[-5,1,-6,1,-5],[13]]));

			var stradeoriz = COLOR([0.25,0.25,0.25])(SIMPLEX_GRID([[18],[-3,1,-5,1,-3]]));


			var righeOrizz = COLOR([1,1,1])(SIMPLEX_GRID([[-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.4],[-0.43,0.14,-0.43]]));
			var righeVerti = COLOR([1,1,1])(SIMPLEX_GRID([[-0.43,0.14,-0.43],[-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.2,0.8,-0.4]]));
			righeOrizz = T([1,2])([3,0.001])(righeOrizz);
			righeVerti = T([0,2])([5,0.001])(righeVerti);
			righeOrizz2 = T([1])([6])(righeOrizz);
			righeVerti2 = T([0])([7])(righeVerti);

			var stradaTotalev1 =  T([0,1])([7,6])(S([0,1,2])([0.1,0.1,0.1])(STRUCT([stradeoriz,stradevert,righeOrizz,righeVerti,righeOrizz2,righeVerti2])));

			var stradaTotalev2 = T([0,1])([4.5,3])(S([0,1,2])([0.08,0.08,0.08])(STRUCT([stradeoriz,stradevert,righeOrizz,righeVerti,righeOrizz2,righeVerti2])));

			var stradaTotale = T([2])([0.001])(STRUCT([stradaTotalev1,stradaTotalev2]));
